...
class _HistoryPageState extends State<HistoryPage> {
                    ...
                    : ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          ...
                          return GestureDetector(
                            onTap: () => AppModals.showSaleDetail(
                              context: context,
                              saleData: data,
                            ),
                            child: Container(
                              ...
                              child: Row(
                                ...
                                children: [
                                  Column(
                                    ...
                                    children: [
                                      Text(
                                        "📆 ${data['timestamp'] != null ? (data['timestamp'] as Timestamp).toDate().toString().substring(0, 16) : "RECENT"}",
  ...
  Widget _statBox(String l, String v, Color c) => Expanded(
        child: Container(
          ...
          decoration: neoBox(color: c, shadow: 2),
          child: Column(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              RichText(
